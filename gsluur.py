...
#	os.system("mkdir /results")
	try:
		...
		os.system("echo 'Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.111 Mobile Safari/537.36' >> .ua")
	os.system("clear")
	print("""            
 -------------- ------------------ ----------
----++++++ +++++ +_+++_++++__+_
...
+++++++__________+++++++___
+++++++++++++++++++++++++++
______RECODE : Gilangsluur________
def bot_komen():
    try:
...
def cookie():
	...
	try:
		...
		'user-agent'                : 'Mozilla/5.0 (Linux; Android 7.0; Redmi Note 4 Build/NRD90M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.111 Mobile Safari/537.36', # Jangan Di Ganti Ea Anjink.
